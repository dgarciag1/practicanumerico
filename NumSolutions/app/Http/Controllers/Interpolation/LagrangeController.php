...
class LagrangeController extends Controller
{
    ...
    {
        return view('user.interpolation.lagrange.initial');
    }
    ...
    public function values(Request $request)
    {
        ...
        return view('user.interpolation.lagrange.values')->with("data",$data);
    }
    ...
    public function results(Request $request)
    {
        ...
        $data = [];   
        $data['table'] = $table;
        $command = 'python "'.public_path().'\methods\lagrange.py" '."{$table}";
        exec($command, $output);
        $data["title"] = __('interpolation.lagrange.results');
        $data["results"] = $output;
        $data["error"] = false;
        ...
        return view('user.interpolation.lagrange.results')->with("data",$data);
