...
class CubicController extends Controller
{
    ...
    {
        return view('user.interpolation.cubic.initial');
    }
    ...
    public function values(Request $request)
    {
        ...
        return view('user.interpolation.cubic.values')->with("data",$data);
    }
    ...
    public function results(Request $request)
    {
        ...
        $data = [];   
        $data['table'] = $table;
        $command = 'python "'.public_path().'\methods\cubic_spline.py" '."{$table}";
        exec($command, $output);
        $data["title"] = __('interpolation.cubic.results');
        $data["results"] = $output;
        $data["error"] = false;
        ...
        return view('user.interpolation.cubic.results')->with("data",$data);
