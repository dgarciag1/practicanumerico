...
class GaussController extends Controller
{
    ...
    {
        return view('user.arrays.gauss.initial');
    }
    ...
    public function values(Request $request)
    {
        ...
        return view('user.arrays.gauss.values')->with("data",$data);
    }
    ...
    public function results(Request $request)
    {
        ...
        $command = 'python "'.public_path().'\methods\gauss_seidel.py" '."{$matrix} {$vector} {$initial} {$tolerance} {$iterations}";
        exec($command, $output);
        $data["title"] = __('arrays.gauss.results');
        $data["error"] = false;
        ...
        return view('user.arrays.gauss.results')->with("data",$data);
