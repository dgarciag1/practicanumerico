...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">{{ __('functions.names.falseRule') }}</div>
                <div class="card-body">
                @if($errors->any())
                <ul id="errors">
